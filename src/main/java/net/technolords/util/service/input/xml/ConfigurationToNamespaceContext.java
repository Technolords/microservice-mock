...
import net.technolords.util.dto.jaxb.namespace.NamespaceConfig;
import net.technolords.util.dto.jaxb.namespace.NamespaceList;
...
public class ConfigurationToNamespaceContext {
    private static final Logger LOGGER = LoggerFactory.getLogger(ConfigurationToNamespaceContext.class);
